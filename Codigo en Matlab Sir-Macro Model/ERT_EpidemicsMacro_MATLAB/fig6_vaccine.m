...
leg1=legend('Basic SIR-Macro Model','Model with Vaccines','Best Simple Containment Policy with Vaccines');
set(leg1,...
    'Position',[-0.0704335567178815 0.894078940309976 1.19107142857143 0.044047619047619],...
    'Orientation','horizontal');
legend boxoff;

suptitle2('Figure 6: SIR-Macro Model With Vaccines');
orient landscape
print -dpdf -fillpage epidemic_simulation_fig6
