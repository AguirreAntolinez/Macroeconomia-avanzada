...
%Perturbation 2
cd baseline_optimal_command_containment;
load results_command_containment_basicSIRmacro;
cd ..
Iperturb2=I;
Sperturb2=S;
Rperturb2=R;
...
leg1=legend('Basic SIR-Macro Model','Best Simple Containment Policy','Simple Command Containment Policy');
set(leg1,...
    'Position',[-0.0704335567178815 0.894078940309976 1.19107142857143 0.044047619047619],...
    'Orientation','horizontal');
legend boxoff;

suptitle2('Figure 3: Basic SIR-Macro Model With and Without Containment');
orient landscape
print -dpdf -fillpage epidemic_simulation_fig3
