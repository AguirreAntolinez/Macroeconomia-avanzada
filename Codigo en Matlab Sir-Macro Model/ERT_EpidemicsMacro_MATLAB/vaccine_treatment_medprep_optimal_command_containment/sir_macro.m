...
kappa=0.9;%0;            %Slope of pid-function in endog. pid scenario
...
elseif use_parallel==1
      opts_fmincon=optimoptions('fmincon','Display','iter','MaxIterations',30000,'OptimalityTolerance',1e-7,'ConstraintTolerance',1e-7,'MaxFunctionEvaluations',100000,'UseParallel',true,'FiniteDifferenceStepSize',1e-3,'Algorithm','interior-point');
end
...
%initial guess for command containment
...
suptitle('Figure XX1: Command Containment in the Benchmark SIR-Macro Model');
orient landscape
...
suptitle('Figure XX2: Command Containment in the Benchmark SIR-Macro Model');
orient landscape
print -dpdf -fillpage epidemic_simulation_figXX2


%Save workspace
save results_command_containment_benchmarkSIRmacro
