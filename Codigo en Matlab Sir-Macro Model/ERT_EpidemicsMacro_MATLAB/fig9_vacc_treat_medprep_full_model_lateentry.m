...
%Perturbation 2
cd vaccine_treatment_medprep_optimal_lateentry_w33;
load results_vaccine_treatment_medprep_optimal_lateentry;
cd ..
Iperturb2=I;
Sperturb2=S;
Rperturb2=R;
...
plot(time,100*Sperturb2(1:horz),'r-.','LineWidth',2);hold on
plot(time,100*Sbase(1:horz),'b-','LineWidth',2);hold on
box off;
...
plot(time,100*Rperturb2(1:horz),'r-.','LineWidth',2);hold on
plot(time,100*Rbase(1:horz),'b-','LineWidth',2);hold on
box off;
...
leg1=legend('Benchmark SIR-Macro Model','Best Simple Containment Policy','Late Start of Best Simple Containment Policy (Week 33)');
set(leg1,...
    'Position',[-0.0704335567178815 0.894078940309976 1.19107142857143 0.044047619047619],...
    'Orientation','horizontal');
legend boxoff;

suptitle3('Figure 9: Benchmark SIR-Macro Model (Vaccines, Treatment, Med. Preparedness)');

orient landscape
print -dpdf -fillpage epidemic_simulation_fig9
